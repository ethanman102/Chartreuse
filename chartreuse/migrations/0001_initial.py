# Generated by Django 5.1.1 on 2024-10-20 05:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commentType', models.CharField(choices=[('text/commonmark', 'text/commonmark'), ('text/plain', 'text/plain'), ('application/base64', 'application/base64'), ('image/png;base64', 'image/png;base64'), ('image/jpeg;base64', 'image/jpeg;base64')], default='text/markdown', max_length=50)),
                ('dateCreated', models.DateTimeField(auto_now_add=True)),
