...
urlpatterns = [
    ...
    # Follow Request URLs
    re_path(r"authors/(?P<url_id>.+\d)/post/(?P<post_id>.+\d)/",post_view.PostDetailView.as_view(),name="profile_view_post"),
    re_path(r"authors/accept/(?P<followed>.+\d)/(?P<follower>.+\d)/", profile_view.follow_accept,name="profile_follow_accept"),
    re_path(r"authors/reject/(?P<followed>.+\d)/(?P<follower>.+\d)/", profile_view.follow_reject,name="profile_follow_reject"),
    re_path(r"authors/unfollow/(?P<followed>.+\d)/(?P<follower>.+\d)/",profile_view.profile_unfollow,name="profile_unfollow"),
    re_path(r"authors/followrequest/(?P<requestee>.+\d)/(?P<requester>.+\d)/",profile_view.profile_follow_request,name="profile_follow_request"),
    re_path(r"authors/following/(?P<user_id>.+\d)/",follow_list_view.FollowListDetailView.as_view(),name="user_following_list"),
    re_path(r"authors/followers/(?P<user_id>.+\d)/",follow_list_view.FollowListDetailView.as_view(),name="user_followers_list"),
    re_path(r"authors/friends/(?P<user_id>.+\d)/",follow_list_view.FollowListDetailView.as_view(),name="user_friends_list"),
    re_path(r"authors/(?P<url_id>.+\d)/", profile_view.ProfileDetailView.as_view(),name="profile"),
    ...
    # Github URLs
    re_path(r"github/(?P<user_id>.+\d)/events/", github.get_events, name="get_events"),
    re_path(r"github/(?P<user_id>.+\d)/starred/", github.get_starred, name="get_starred"),
    re_path(r"github/(?P<user_id>.+\d)/subscriptions/", github.get_subscriptions, name="get_subscriptions"),
    ...
    re_path(r'.+\d/like-post/', support_functions.like_post, name='like-post'),
    re_path(r'.+\d/send-follow-request/', support_functions.send_follow_request, name='send-follow-request'),

    re_path(r'homepage/post/(?P<post_id>.+\d)/edit/', support_functions.edit_post, name='edit-post'),
    re_path(r'homepage/post/(?P<post_id>.+\d)/delete/', support_functions.delete_post, name='delete-post'),
    re_path(r'homepage/post/(?P<post_id>.+\d)/update/', support_functions.update_post, name='update-post'),
    re_path(r'homepage/post/(?P<post_id>.+\d)/', post_view.PostDetailView.as_view(), name='view-post'),
] 
