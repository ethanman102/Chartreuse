...
class ProfileDetailView(DetailView):
    ...
    def get_posts(self,post_access,user):
        ...
        if post_access == "public":
            ...
            posts = Post.objects.filter(user=user,visibility="FRIENDS") | Post.objects.filter(visibility="PUBLIC",user=user) | Post.objects.filter(visibility="UNLISTED",user=user)
